...
// ============================================================================
// Legacy JNI entry points kept as NO-OP stubs so Kotlin glue still links.
// We will remove them from Kotlin/UI in the next cleanup pass.
// ============================================================================

extern "C" JNIEXPORT void JNICALL
Java_com_breathinghand_audio_OboeSynthesizer_nativeLoadWavetableFromDirectBuffer(JNIEnv*, jobject, jlong, jobject, jlong) {
    // No-op: wavetable engine removed.
}

extern "C" JNIEXPORT void JNICALL
Java_com_breathinghand_audio_OboeSynthesizer_nativeRegisterSample(JNIEnv*, jobject, jlong, jobject, jlong, jint, jint, jint, jstring) {
    // No-op: sample engine removed.
}

extern "C" JNIEXPORT jobjectArray JNICALL
Java_com_breathinghand_audio_OboeSynthesizer_nativeGetLoadedSampleNames(JNIEnv* env, jobject, jlong) {
    jclass strClass = env->FindClass("java/lang/String");
    return env->NewObjectArray(0, strClass, nullptr);
}

extern "C" JNIEXPORT void JNICALL
Java_com_breathinghand_audio_OboeSynthesizer_nativeUnloadSample(JNIEnv*, jobject, jlong, jint) {
    // No-op
}

extern "C" JNIEXPORT void JNICALL
Java_com_breathinghand_audio_OboeSynthesizer_nativeSetFilterCutoff(JNIEnv*, jobject, jlong, jint, jfloat) {
    // No-op
}

extern "C" JNIEXPORT void JNICALL
Java_com_breathinghand_audio_OboeSynthesizer_nativeSetEnvelope(JNIEnv*, jobject, jlong, jint, jfloat, jfloat, jfloat, jfloat) {
    // No-op
}

extern "C" JNIEXPORT void JNICALL
Java_com_breathinghand_audio_OboeSynthesizer_nativeSetWaveform(JNIEnv*, jobject, jlong, jint) {
    // No-op
}
