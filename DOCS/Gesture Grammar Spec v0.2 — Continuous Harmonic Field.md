...
It does not define harmony theory in detail; it defines **how gestures acquire meaning**.
...
- must never be re-evaluated continuously.
...
If re-touch occurs outside the time/spatial tolerance, normal evaluation resumes.

---

## 11. Non-Negotiable Constraints

- Gestures are never used for timing control.
- Time-based logic never defines harmonic meaning.
- Harmonic change is continuous and physical.
